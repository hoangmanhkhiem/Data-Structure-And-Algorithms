...
+ [Dijkstra’s](algorithms/Dijkstra’s_Shortest_Path.cpp)
+ [Kruskal’s](algorithms/Kruskal’s_Minimum_Spanning_Tree.cpp)
+ [Prim’s](algorithms/Prim’s_Algorithm.cpp)
...
+ [Uses vector](Uses/vecto.cpp)
+ [Set](Uses/set.cpp)
+ [Pair](Uses/pair.cpp)
+ [Stack](algorithms/stack.cpp)
+ [Uses Stack](Uses/stack.cpp)
+ [Queue](algorithms/queue.cpp)
+ [Uses Queue](Uses/queue.cpp)
+ [Map](Uses/map.cpp)
+ [Deque](Uses/deque.cpp)
+ [Priority Queue](Uses/priority_queue.cpp)
...
### Searching
+ [Linear Search](algorithms/LinearSearch.cpp)
